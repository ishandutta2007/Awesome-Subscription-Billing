...
*Focused on Recurring Billing, Usage-Based Pricing, Subscription Lifecycle, Invoicing, Dunning & Revenue Operations*
...
**Examples** include Chargebee, Recurly, Maxio, Paddle, Stripe Billing, Zuora, Chargify, FastSpring, Billsby, and Kill Bill (the category leaders and major open platform).
